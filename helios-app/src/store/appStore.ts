...
export type NavView = 'home' | 'explore' | 'spaces' | 'lifestyle' | 'live' | 'chat' | 'projects' | 'profile' | 'apps' | 'learn'
...
const NAV_ORDER: NavView[] = ['home', 'explore', 'apps', 'projects', 'learn', 'spaces', 'lifestyle', 'live', 'chat', 'profile']
