...
export const MINI_APP_CATALOG: MiniAppDefinition[] = [
  ...
  { id: 'presentation', name: 'Presentation', shortName: 'PowerPoint', projectType: 'presentation', description: 'Slide thumbnails, editing, presenting and project sharing.', accent: '#C43E1C', icon: 'slides', live: true, category: 'Slides' },
  ...
  { id: 'spreadsheet', name: 'Spreadsheet', shortName: 'Excel', projectType: 'spreadsheet', description: 'Editable cells, formulas, tables, charts and data analysis.', accent: '#107C41', icon: 'sheet', live: true, category: 'Sheets & Data' },
  ...
  { id: 'stocks', name: 'Stocks', shortName: 'Stocks', projectType: 'doc', description: 'A live watchlist of prices you can open any time while you work.', accent: '#0F9D58', icon: 'chart', live: true, category: 'Sheets & Data' },
  ...
  { id: 'word-docs', name: 'Word Documents', shortName: 'Word', projectType: 'writing', description: 'Create polished documents with headings, lists, tables and citations.', accent: '#185ABD', icon: 'writing', live: true, category: 'Docs & Writing' },
